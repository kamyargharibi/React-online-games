...
const Games = () => {
  ...
  useEffect(() => {
    ...
    window.scrollTo(0, 0);
    // current title
    document.title = "Play - Games List";
  }, []);
  ...
  return (
    <div className="mx-auto my-2 w-full max-w-[1216px] bg-primary-light px-4 py-8 dark:bg-primary-dark sm:px-6 sm:py-4 md:w-[95%] md:rounded-3xl lg:px-8">
      {loading ? (
